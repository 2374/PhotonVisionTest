...
public final class Vector2 implements Interpolable<Vector2>, Serializable {
    ...
    /**
     * 
     * @param Vector2 vector to be translated
     * @return Translation2d without a rotation
     */
    public static Translation2d vector2ToTranslation2d(Vector2 vector2) {
        return new Translation2d(vector2.x, vector2.y);
    }

    /**
     * 
     * @param Translation2d translation to be vectored
     * @return Vector2 dropping the rotation
     */
    public static Vector2 translation2dToVector2(Translation2d translation2d) {
