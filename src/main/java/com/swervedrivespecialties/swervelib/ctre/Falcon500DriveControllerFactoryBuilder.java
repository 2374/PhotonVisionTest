...
public final class Falcon500DriveControllerFactoryBuilder {
    ...
    private class FactoryImplementation implements DriveControllerFactory<ControllerImplementation, Integer> {
        ...
        public ControllerImplementation create(Integer driveConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            TalonFX motor = new TalonFX(driveConfiguration, Constants.CAN_BUS_NAME_DRIVETRAIN);
    ...
    private class ControllerImplementation implements DriveController {
        ...
        public double getDistance() {
            // get the ticks multiply that by 1/10 of the sensorVelocityCoefficient to yield
            // the sensorPositionCoeeficient (see above code), multiply that result by the
            // sensorPosition and we should have the distance in meters (as the wheel
            // diameter
            // is in meters)
            double distanceInMeters = motor.getSelectedSensorPosition() * sensorVelocityCoefficient / 10.0;
