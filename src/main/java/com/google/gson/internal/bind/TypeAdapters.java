...
public final class TypeAdapters {
                ...
                switch (tokenType) {
                    ...
                    case STRING:
                        ...
                        if (intValue == 0) {
                            ...
                            throw new JsonSyntaxException("Invalid bitset value " + intValue
                                    + ", expected 0 or 1; at path " + in.getPreviousPath());
                        }
                        break;
                    case BOOLEAN:
                        set = in.nextBoolean();
    ...
    public static final TypeAdapter<Currency> CURRENCY = new TypeAdapter<Currency>() {
        ...
        public Currency read(JsonReader in) throws IOException {
            ...
            try {
                ...
                throw new JsonSyntaxException("Failed parsing '" + s + "' as Currency; at path " + in.getPreviousPath(),
                        e);
            }
        }
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public EnumTypeAdapter(final Class<T> classOfT) {
            // try {
            // Uses reflection to find enum constants to work around name mismatches for
            // obfuscated classes
            // Reflection access might throw SecurityException, therefore run this in
            // privileged context;
            // should be acceptable because this only retrieves enum constants, but does not
            // expose anything else
            // Field[] constantFields = AccessController.doPrivileged(new
            ...
            // constantField.getAnnotation(SerializedName.class);
            // if (annotation != null) {
